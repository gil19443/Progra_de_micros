;*******************************************************************************                                                                       *
;    Filename:		    Laboratorio8.asm                              *
;    Date:                  08/09/2020                                         *
;    File Version:          v.1                                                *
;    Author:                Carlos Gil                      *
;    Company:               UVG                                                *
;    Description:           joystick y servomotores                                                                                                           *
;*******************************************************************************
#include "p16f887.inc"
...
DISPLAY_1:
    ...
    SEP_NIBBLES: ;rutina que separa en nibbles el valor que recibe el adc para el ejex
    MOVFW   CCPR1L
    MOVWF   DISPLAY0
    SWAPF   CCPR1L, W
    MOVWF   DISPLAY1
...
;***********************TMR2****************************************************
 ...
 ;******************************************************************************
    ...
    CONFIGURACION_CCP1:
    BANKSEL TRISC
    MOVLW   .187	; PARA TMR2 FUNCIONAR CON 3ms
    MOVWF   PR2
    BANKSEL CCP1CON
    BCF	    CCP1CON, 7
    BCF	    CCP1CON, 6		
